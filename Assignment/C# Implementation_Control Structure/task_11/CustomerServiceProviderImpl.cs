...
namespace Banking_System
{
    public class CustomerServiceProviderImpl : ICustomerServiceProvider
    {
        ...
        public void getAccountDetails(long account_number)
        {
            ...
            AbstractAccount account = accountList[account_number];
            Console.WriteLine($"\nAccount Number: {account.AccountNumber}, Type: {account.AccountType}, Balance: ₹{account.Balance}");

            Console.WriteLine($"Customer First Name: {account.Customer.FirstName}, Customer Last Name: {account.Customer.LastName},Email: {account.Customer.Email}");
        }
    }
}
